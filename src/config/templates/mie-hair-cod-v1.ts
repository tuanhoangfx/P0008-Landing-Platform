...
export const mieHairCodV1: HairLandingConfig = {
  slug: "mie-hair-cod-v1",
  meta: {
  ...
  hero: {
    ...
    gallery: [
      { slot: "a", image: "/products/001/gallery-oecgz.png", alt: "Side view" },
      {
        slot: "b",
        image: "/products/001/screenshot-2026-05-06-095552-20260506034023-q7xfl.png",
        alt: "Front view",
      },
      {
        slot: "c",
        image: "/products/001/screenshot-2026-05-06-102548-20260506034016-ccyyt.png",
        alt: "Profile view",
      },
      { slot: "d", image: "/products/001/gallery-hr0_i.png", alt: "Back view" },
    ],
    bannerImage:
